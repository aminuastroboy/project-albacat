          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl space-y-3">
              ...
              <p className="alb-muted text-sm leading-7 md:text-base">
                A working Islamic history audio platform for Albani Zaria using Cloudinary audio streaming.
              </p>
                  ...
                  <div className="space-y-2">
                    ...
                    {current ? (
                      <>
                        ...
                        <p className="alb-muted max-w-3xl text-sm leading-7">{current.description}</p>
                      </>
                    ) : (
